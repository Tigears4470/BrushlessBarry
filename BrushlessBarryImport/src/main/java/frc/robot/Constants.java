...
public final class Constants {
    ...
    // Balancing
    public static final double K_PLAT_DEGREE_THRESH = 10; // angle at which the robot is considered to be on the
                                                          // platform
    public static final double K_BALANCE_THRESH_DEG = 4.2; // angle at within which the robot is considered to be
                                                           // balanced
    ...
    public static final class K_ExtSub {
        ...
        public static final double gearRadius = 14.0 / 16; // inches (measured from gear in contact with inner
                                                           // component)
    ...
    public static final class K_IntakeSub {
        ...
        public static final boolean isUsingIntake = false; // If is using the intake subsystem
    ...
    public static final class K_ElevatorSub {
        // NEED TO INVERTONE OF THEM TO SWITCH DIRECTIOn
        public static final int MOTOR_1_CAN = 11; // lead
        public static final int MOTOR_2_CAN = 12; // follow
